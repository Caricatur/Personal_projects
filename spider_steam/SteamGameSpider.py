...
from spider_steam.spider_steam.items import SpiderSteamItem
...
class SteamgamespiderSpider(scrapy.Spider):
    ...
    def parse_keyword_response(self, response):
        ...
        def parse(self, response):
            ...
            game_rating_count = response.xpath('//div[@class="user_reviews"]/div[@itemprop="aggregateRating"]//span[contains(@class,"responsive_hidden")]/text()').extract()
            ...
            item['game_reting_count'] = item['game_review_count'][1:item['game_review_count'].find(')')]
            ...
            item['game_platforms'] = sorted(list(set(game_platforms)))
            yield item
